...
app.use(cors({ origin: ['http://localhost:3000', 'https://front-end-fork-vegatality.vercel.app','https://poodaeng-poodaeng.vercel.app','https://poodaeng-dsv2ksbi3-poodaeng.vercel.app'], credentials: true }));
